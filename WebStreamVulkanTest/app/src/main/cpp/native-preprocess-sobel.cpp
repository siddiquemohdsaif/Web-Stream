...
static jstring runSobel(
    ...
    try {
        ...
        std::vector<uint8_t> output;
        const std::string report = webstreamRunSobelBytes(input, output, width, height, shader);
...
Java_app_builderx_ogfa_camerapipelinetest_PreprocessingTest_nativeRunSobel(
    JNIEnv* env, jobject object, jbyteArray inputArray, jbyteArray outputArray,
    jint width, jint height, jbyteArray shaderArray) {
    return runSobel(env, object, inputArray, outputArray, width, height, shaderArray);
}

extern "C" JNIEXPORT jstring JNICALL
Java_app_builderx_ogfa_camerapipelinetest_LivePreprocessingActivity_nativeRunSobel(
    JNIEnv* env, jobject object, jbyteArray inputArray, jbyteArray outputArray,
    jint width, jint height, jbyteArray shaderArray) {
    return runSobel(env, object, inputArray, outputArray, width, height, shaderArray);
}
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_w3n_webstreamvulkantest_JoinCallActivity_nativeRunSobel(
    JNIEnv* env, jobject object, jbyteArray inputArray, jbyteArray outputArray,
    jint width, jint height, jbyteArray shaderArray) {
    return runSobel(env, object, inputArray, outputArray, width, height, shaderArray);
}
