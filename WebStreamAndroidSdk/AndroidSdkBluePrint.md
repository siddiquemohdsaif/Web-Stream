...
6             8      timestamp
14            1      format integer; jpeg = 1, jxl = 2, h264 = 3
15            2      width
17            2      height
19            2      fps
21            4      bitrate
...
Current H.264 transport behavior:

- H.264 is the default outgoing video format for new calls.
- The Android SDK batches 5 captured frames into one H.264 binary payload.
- At 15 FPS this produces about 3 packets per second; at 20 FPS this produces about 4 packets per second.
- The existing binary packet layout is reused, with `format = h264`.
- JPEG and JXL remain supported as compatibility/fallback formats.
- The Node server validates and relays H.264 binary packets without base64 conversion.
