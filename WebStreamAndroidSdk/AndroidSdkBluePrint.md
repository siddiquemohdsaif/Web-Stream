...
- Keep JPEG as the initial binary payload format unless JPEG XL (JXL) is added later as a separate format option.
- Decode incoming binary JPEG payloads back into renderable frames for `WebStreamVideoTrack`.
